...
Scenario: Density Splits project builds successfully
    ...
    And the field "apiKey" for multipart request 6 equals "TEST_API_KEY"
    And the field "versionName" for multipart request 6 equals "1.0"
    And the field "appId" for multipart request 6 equals "com.bugsnag.android.example"
    ...
    And the payload field "appVersion" equals "1.0" for request 13
    And the payload field "apiKey" equals "TEST_API_KEY" for request 13
